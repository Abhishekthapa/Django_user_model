    ...
    with fileinput.FileInput("checktest", inplace=False) as file:
        ...
        for line in file:
            if "<version>" in line:
                ...
                print(line.replace(version, value + "</version>"), end='\n')
            else:
                print(line, end="")

        print("version changed to: ", value, " in pom.xml")

    # change jarversion for bash and python scripts.
    change_JARversion_for_pyfiles("checktest", "DasCascading-", value)

    # # update processing scripts
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/jobs/production_cascading.py", "DasCascading-", value)
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/jobs/emr_production_cascading.py", "DasCascading-", value)
    #
    # # # update parallel processing script
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/jobs/parallel_emr_production_cascading.py", "DasCascading-", value)
    #
    # # # update real time migration script
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/jobs/realTime_migration.py", "DasCascading-", value)
    #
    # # # update masterTables.sh
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/bin/masterTables.sh", "DasCascading-", value)
    #
    # # # update historicalToPx.sh
    # change_JARversion_for_pyfiles("historicalToPx.sh", "DasCascading-", value)
    #
    # # # update historicalToPxEmr.sh
    # change_JARversion_for_pyfiles("../src/main/resources/dasProduction/bin/historicalToPxEmr.sh", "DasCascading-", value)
...
if __name__ == '__main__':
    ...
    change_version(nextRelease)

    repository.git.add("./check.py", "./checktest")
    repository.git.commit('-m',
                          'Changed pom, properties and productions scripts for develop with Version: ' + nextRelease)
